...
import { Dimensions, StatusBar, View, Text, StyleSheet, ScrollView, TouchableOpacity, ImageBackground } from 'react-native';
        ...
        <View style={{
          ...
          <View style={{ paddingTop: 15 }} accessible={true} accessibilityLabel="Explore the beautiful places in Malaysia">
            ...
            <TouchableOpacity
              ...
              <Text styles={{ color: COLORS.grey }}>Search Place</Text>
            </TouchableOpacity>
          </View>
        </View>
        <ListCategories />
